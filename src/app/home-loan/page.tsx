    ...
    <div className="flex flex-col">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#050a14] mb-12 text-center">Why Choose Home Loan?</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center bg-[#f9fafb] border border-[#e5e7eb] rounded-2xl p-12">
          ...
          <p className="text-xl text-[#6b7280] mb-8">Get your home loan approved</p>
          <Link
            href="/contact-us"
