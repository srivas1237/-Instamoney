    ...
    <div className="flex flex-col">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-gray-100">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold mb-6">
                <span className="gold-text">Car Loan</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                Finance for new and used cars. Drive your dream car home with easy EMIs.
              </p>
            </div>
            <div className="relative">
              <LoanForm defaultLoanType="car" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center glass-effect rounded-3xl p-12 border border-amber-900/30">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-100 mb-6">Ready to Drive Your Dream Car?</h2>
          <p className="text-xl text-gray-400 mb-8">Apply for car loan and get instant approval</p>
          <Link
            href="/contact-us"
