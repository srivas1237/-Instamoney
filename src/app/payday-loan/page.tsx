...
export const metadata: Metadata = {
  title: 'Payday Loan - Salary Advance | InstaMoney',
  description: 'Salary linked emergency loan from ₹1,000 to ₹1,00,000. Repay on your next salary date.',
}

const features = [
  'Loan Amount: ₹1,000 – ₹1,00,000',
  'Repayment on Next Salary Date',
  'Instant Approval',
  'No Credit Check (for selected customers)',
    ...
    <div className="flex flex-col">
      <section className="relative overflow-hidden py-20 lg:py-28">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1553729459-efe14ef6055d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80")',
          }}
        ></div>
        {/* Overlay */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-gray-100">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold mb-6">
                <span className="gold-text">Payday Loan</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                Salary-linked emergency loan. Get funds before your next salary arrives.
              </p>
            </div>
            <div className="relative">
              <LoanForm defaultLoanType="payday" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center glass-effect rounded-3xl p-12 border border-amber-900/30">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-100 mb-6">Need Cash Before Salary?</h2>
          <p className="text-xl text-gray-400 mb-8">Apply for payday loan and get instant funds</p>
          <Link
            href="/contact-us"
